...
export interface IronPdfServiceClient extends grpc.Client {
  ...
  Pdfium_Page_ExtendPage(argument: _ironpdfengineproto_PdfiumExtendPageRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_ExtendPage(argument: _ironpdfengineproto_PdfiumExtendPageRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_ExtendPage(argument: _ironpdfengineproto_PdfiumExtendPageRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  Pdfium_Page_ExtendPage(argument: _ironpdfengineproto_PdfiumExtendPageRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageExtendPage(argument: _ironpdfengineproto_PdfiumExtendPageRequestP, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageExtendPage(argument: _ironpdfengineproto_PdfiumExtendPageRequestP, metadata: grpc.Metadata, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageExtendPage(argument: _ironpdfengineproto_PdfiumExtendPageRequestP, options: grpc.CallOptions, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
  pdfiumPageExtendPage(argument: _ironpdfengineproto_PdfiumExtendPageRequestP, callback: grpc.requestCallback<_ironpdfengineproto_EmptyResultP__Output>): grpc.ClientUnaryCall;
